...
def parse_args():
    ...
    parser.add_argument('--trust_remote_code', type=bool, default=True, choices=[False, True], help='是否下载模型')
...
def train(global_args):
    ...
    tokenizer = AutoTokenizer.from_pretrained(global_args.model_name_or_path, trust_remote_code=global_args.trust_remote_code)
